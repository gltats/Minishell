...
/*   Updated: 2023/05/19 17:52:21 by tgomes-l         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int print_error(int error, const char *arg)
{
    ...
    // Check the value of 'error' to determine the type of error
    if (error == -1)
    ...
    i = 0;
    // Print the argument until '=' character or until the end if error is -3
...
int ft_export_checker(char **args, t_env *env, t_env *secret)
{
    ...
    // Check if the argument is starting with '='
    if (args[1][0] == '=')
        error_ret = -3;
